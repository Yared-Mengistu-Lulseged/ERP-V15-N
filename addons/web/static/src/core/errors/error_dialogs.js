...
ErrorDialog.title = _lt("OnPoint ERP Error");

// -----------------------------------------------------------------------------
// Client Error Dialog
// -----------------------------------------------------------------------------
export class ClientErrorDialog extends ErrorDialog {}
ClientErrorDialog.title = _lt("OnPoint ERP Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _lt("OnPoint ERP Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = this.env._t("OnPoint ERP Server Error");
                break;
            case "script":
                this.title = this.env._t("OnPoint ERP Client Error");
                break;
            case "network":
                this.title = this.env._t("OnPoint ERP Network Error");
                break;
        }
    }
...
export class WarningDialog extends Dialog {
    setup() {
        super.setup();
        this.title = this.env._t("OnPoint ERP Warning");
        this.inferTitle();
...
export class RedirectWarningDialog extends Dialog {
    setup() {
        ...
        this.title = capitalize(subType) || this.env._t("OnPoint ERP Warning");
        this.message = message;
...
SessionExpiredDialog.title = _lt("OnPoint ERP Session Expired");
